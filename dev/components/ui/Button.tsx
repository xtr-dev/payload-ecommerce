...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-gray-700 text-white hover:bg-gray-800 focus:ring-gray-500 shadow-sm',
    outline: 'border-2 border-gray-700 bg-white text-gray-900 hover:bg-gray-100 focus:ring-blue-500 shadow-sm',
